...
/** @class MultiRegExp 
* @param {Iterable.<RegExp>} iterable */
var MultiRegExp = (function () {
    function MultiRegExp(iterable) {
    ...
    _createClass(MultiRegExp, [{
        key: 'firstMatch',
        /** @memberof MultiRegExp 
        * @instance 
        * @method firstMatch 
        * @param {string} string 
        * @returns {RegExpMatch} */value: function firstMatch(string) {
        ...
        * @returns {RegExpMatch} */value: function findMatch(string) {
        ...
        * @param {string} string 
        * @param {number} [start=0] 
        * @returns {MultiRegExpIterable} */value: function allMatches(string) {
            var start = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
        ...
        * @method exec 
        * @param {string} string 
        * @returns {RegExpMatch} */value: function exec(string) {
            var found = undefined,
        ...
        * @method test 
        * @param {string} string 
        * @returns {boolean} */value: function test(string) {
